...
public class SqsCreateSubscribe {
    ...
    public SqsCreateSubscribe(AmazonSNS snsClient, @Qualifier("productEventsTopic") Topic topic) {
        ...
        Topics.subscribeQueue(snsClient, sqsClient, topic.getTopicArn(), productEventsQueueUrl);
